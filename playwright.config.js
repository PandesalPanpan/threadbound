...
export default defineConfig({
  ...
  testMatch: ['**/simple-loop.spec.js', '**/rarity-contract.spec.js', '**/inventory-rich-card.spec.js', '**/shop-rich-card.spec.js', '**/profile-rich-card.spec.js', '**/bank-rich-card.spec.js'],
  fullyParallel: false,
  workers: 1,
