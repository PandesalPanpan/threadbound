...
export function createApp({ config, threadedGateway, repository, codexRepository, manifestRepository }) {
  ...
  app.post('/api/towns/:townId/npcs/:npcId/interact', requireConnection, (request, response) => {
