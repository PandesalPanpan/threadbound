...
function codexPage(authMode) {
  return `<!doctype html><html lang="en"><head>${sharedHead('Threadbound Codex')}</head><body>${topNav('codex', authMode)}<main class="threadbound-page codex-shell"><header class="page-hero"><div><span class="eyebrow">LIVING ARCHIVE</span><h1>Codex</h1><p>Everything the world has revealed so far.</p></div></header><div id="codex-status" data-testid="codex-status">Loading…</div><div class="toolbar"><label class="codex-search-control"><span aria-hidden="true">⌕</span><input id="codex-search" data-testid="codex-search" type="search" aria-label="Search the Loom" placeholder="Search the Loom…" autocomplete="off"></label><div id="codex-tabs" class="tabs"></div></div><div id="codex-counts" class="counts"></div><div class="codex-layout"><section id="codex-list" class="codex-list" aria-label="Codex entries"></section><article id="codex-detail" class="codex-detail" data-testid="codex-detail"></article></div><footer class="codex-footer">Authoritative game/content state · not a duplicate wiki</footer></main><script type="module" src="/codex.js"></script></body></html>`;
}
