...
function DungeonSharedCard({ entry, viewerId, assets, onRequest, busy, dashboard, interactive = true }) {
  ...
  if (replay) {
    ...
    const potions = availablePotions.reduce((sum, potion) => sum + Number(potion.quantity || 0), 0) || Number(dashboard?.character?.healthPotions || 0);
