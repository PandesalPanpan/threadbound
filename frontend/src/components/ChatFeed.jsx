export function ChatFeed({ entries = [], receipt = null }) {
  ...
  return (
    <section className="chat-panel" aria-labelledby="battle-feed-title">
      ...
      <div className="chat-composer"><span>Message party or type /command…</span><button type="button" aria-label="Return to Adventure Stream" onClick={() => { window.location.href = '/game'; }}>›</button></div>
    </section>
  );
}
